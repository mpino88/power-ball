...
export const CONSENSUS_GROUPS: ConsensusGroup[] = [
  {
    ...
    description: "La combinación más equilibrada: mezcla los favoritos, los más atrasados, los dueños de este día y los números que saben seguir al sorteo de ayer.",
  ...
  },
  {
    ...
    description: "Para atrapar lo que está caliente hoy mismo: mezcla las rachas ganadoras, las decenas que dominan, las terminaciones en alza y el análisis de dos días seguidos.",
  ...
  },
  {
    ...
    description: "La mezcla perfecta general: Junta el Score más inteligente (nota del 0-100) junto con análisis de decenas, posiciones y fechas actuales.",
